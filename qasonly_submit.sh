...
then
  ...
  singularity exec --nv ~/singularity/pt-cuda-tf python bioMLT/biomlt_alldata.py --output_dir $output_dir  --load_model --max_seq_length 256 --num_train_epochs 20  --batch_size 12 --load_model
fi
