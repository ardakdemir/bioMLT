...
nbest_path='nbest_pred'${model_save_name}
...
do
    ...
    singularity exec --nv ~/singularity/pt-cuda-tf python biomlt.py --predict --load_model_path $output_dir"/"$model_save_name --squad_predict_yesno_file $squad_predict_yesno_file --squad_dir . --nbest_path $nbest_path --load_model --squad_yes_no --init_bert --overwrite_cache --pred_path $pred_path
