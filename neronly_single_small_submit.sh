...
do
    ...
    then
        ...
        echo $dev_file
        echo $test_file
        singularity exec --nv ~/singularity/pt-cuda-tf python bioMLT/biomlt_alldata.py --crf --mode ner  --repeat 5 --output_dir $output_dir  --total_train_steps $total_train_steps --num_train_epochs $epoch_num --ner_train_file $train_file --ner_dev_file $dev_file --ner_test_file $test_file --load_model
    fi
done
