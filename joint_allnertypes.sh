/usr/local/bin/nosh
output_dir='joint_eachner_2304_2'
#test_num=$2
...
do
    ...
    then
        ...
        echo $train_file
        echo $dev_file
        singularity exec --nv ~/singularity/pt-cuda-tf python biomlt_alldata.py --mode joint_flat --output_dir $output_dir  --num_train_epochs $epoch_num --ner_train_file $train_file --ner_dev_file $dev_file
    fi
done
