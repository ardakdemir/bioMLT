...
def parse_args():
    ...
    parser.add_argument(
        "--test_path", default="../biobert_data/BioASQ-9b/BioASQ-task9bPhaseB-testset3", type=str, required=False,
        help="The path to load the model to continue training."
    )
    parser.add_argument(
        "--save_folder", default="../bioasq_tb3_0904", type=str, required=False,
