...
bioasq_preprocessed_8bfolder='/home/aakdemir/biobert_data/BioASQ-8b/'
...
then
    ...
    squad_train_yesno_file=${train_root}'training8b_squadformat_train_yesno.json'
    squad_train_list_file=${train_root}'training8b_squadformat_train_list.json'
    squad_train_factoid_file=${train_root}'training8b_squadformat_train_factoid.json'
...
do
    ...
    test_pref='BioASQ-task8bPhaseB-testset1_squadformat_test_'
    squad_predict_yesno_file=${bioasq_preprocessed_8bfolder}${test_pref}'yesno.json'
    squad_predict_list_file=${bioasq_preprocessed_8bfolder}${test_pref}'list.json'
    squad_predict_factoid_file=${bioasq_preprocessed_8bfolder}${test_pref}'factoid.json'
    ...
    echo "ALL PREDICTIONS ARE STORED IN : "merged_json_${data_type}'_'${test_num}
    python merge_predictions.py ${out_for_bioasq_eval}  'merged_json_'${model_save_name}'_'${data_type}"_"${test_num}
